...
import { getBudgetMonthlyTotal, getBudgetYearlyTotal } from "~/features/budget/queries";
...
export const loader = async ({ request }: Route.LoaderArgs) => {
  ...
  const [budgetMonthlyTotal, budgetYearlyTotal, expensesByYear] = await Promise.all([
